    ...
    public class InputValidator
    {
        ...
        public InputValidator HasLengthEqualOrGreaterThan(int min)
        {
            if (rawString.Length < min)
                errorBuilder.AppendLine(title + " phải ít nhất " + min);
            return this;
        }
        ...
        {
            if (rawString.Length <= min)
                errorBuilder.AppendLine(title + " phải nhiều hơn " + min);
            return this;
        }
        ...
        public InputValidator HasLengthEqualOrLessThan(int max)
        {
            if (rawString.Length > max)
                errorBuilder.AppendLine(title + " phải ít hơn hoặc bằng " + max);
            return this;
        }
        ...
        {
            if (rawString.Length >= max)
                errorBuilder.AppendLine(title + " phải ít hơn " + max);
            return this;
        }
        ...
        public InputValidator HasLengthEqualTo(int length)
        {
            if (rawString.Length != length)
                errorBuilder.AppendLine(title + " phải có đủ " + length);
            return this;
        }
