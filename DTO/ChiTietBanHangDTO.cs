...
namespace DTO
{
    public class ChiTietBanHangDTO
    {
        ...
        public ChiTietBanHangDTO() { }

        public ChiTietBanHangDTO(DataRow row)
        {
        ...
        public ChiTietBanHangDTO(int iD_CTBH, int iD_QA, string ten_QA, float giaBan, int soLuongSanPham)
        {
            ID_CTBH = iD_CTBH;
            ID_QA = iD_QA;
            Ten_QA = ten_QA;
